...
* **Загранпаспорт 10-летний (биометрический)** + копия первой страницы. **Важно:** 5-летние паспорта (небиометрические) **не принимают**. Исключение: дети до 12 лет — возможно, но с ограничениями; после 12 лет — точно нет.  (на октябрь 2025)
