...
* **Загранпаспорт 10-летний (биометрический)** + копия первой страницы. **Важно:** На октябрь 2025 небиометрические 5-летние паспорта точно принимают у детей до 12 лет и вроде как у взрослых тоже(но не точно). Для 5 летних дают шенгенскую визу с ограничениями (в скобках указывают страны, куда нельзя).  **Настоятельно рекомендуется 10-летний** — многие страны Шенгена (например, Франция) не пропускают даже транзитом с 5-летним, что ограничивает маршруты и может стать причиной отказа. В Питере с лета 2025 испанское консульство небиометрические паспорта не принимает.* **Сербский или черногорский ВНЖ (боравак/боравишна дозвола)** + копия (читач или ксерокопия)
...
> [!NOTE]
> **Неполные данные в онлайн-анкете** — это нормально!
>
> При проверке статуса можно скачать PDF анкеты через кнопку «Consular datos de la solicitud». **Не пугайтесь:** в ней будет заполнена только часть данных (обычно базовая информация), **не будет** информации о предыдущих визах, биометрии, деталей поездки, средствах и многого другого.
>
> **Это НЕ ошибка и НЕ означает, что ваши данные потеряны.** Консульство заполняет эту форму в электронном виде только частично — остальная информация хранится в вашей бумажной анкете. Так происходит **у всех заявителей**, независимо от того, насколько тщательно вы заполняли документы.
>
> **Данные меняются динамически:** После того как консульство примет решение и вам придёт письмо о готовности визы, в этой же PDF-анкете появится информация о **типе визы** (однократная/двукратная/мультивиза) и **количестве дней**. Эта информация **всегда совпадает** с тем, что будет вклеено в ваш паспорт.
