...
> [!NOTE]
> Этот гайд — про **туристическую визу (тип C)**. Вопросы по туристическим визам обсуждаются в **[Serbia: visas for other countries (chat)](https://t.me/+fIZUn78R5SUzYjhi)**. По вопросам **digital nomad визы (тип D)** Испании есть отдельный чат: **[DN виза Испании в Белграде](https://t.me/digitalnomadspainserbia)**.

> [!IMPORTANT]
> **Коротко о главном (актуально на апрель 2026):**
> Слоты чаще всего дают тем, кто запросил **за 2.5–3 месяца** до поездки (см. «Реалии» в шаге 1). Визу выдают **за 1–2 дня до вылета** — даже если паспорт сдали месяцы назад. Случаев, когда визу не успели выдать до вылета, не зафиксировано.
...
* **Консульский сбор:** 10 540 RSD на взрослого, **наличными** (карты не принимаются). Для детей 6–12 лет — **в 2 раза меньше**. Дети до 6 лет — **бесплатно**. Сумма может меняться в зависимости от внутреннего курса консульства. Актуально на апрель 2026.
* **Статус дела:** [https://sutramiteconsular.maec.es/](https://sutramiteconsular.maec.es/) → `VISADO` → номер дела (`ESP…`) → год рождения → капча
* **Когда подавать:** официально — не более чем за 6 месяцев до поездки. На практике слоты получали те, кто запрашивал **за 2.5–3 месяца** до поездки (см. «Реалии» в шаге 1).
...
<details>
<summary>Полный список выходных дней (14 дней) <i>[подробнее]</i></summary>
...
* Требуется действующий **ВНЖ/боравак (боравишна дозвола) Сербии или Черногории** (в том числе временный/постоянный).
* **Визаранщики** (без ВНЖ, въезд-выезд по безвизу) **подать документы не могут**.

<details>
<summary><strong>Нет требования о минимальном сроке проживания (6 мес.)</strong> — почему <i>[подробнее]</i></summary>

В Регламенте закона 4/2000 (испанское визовое законодательство) **нет требования о минимальном сроке проживания** (6 месяцев). На практике принимают с любым действующим ВНЖ, главное, чтобы он был действителен на момент подачи и на весь период поездки.
...
2. **Тема:** `[SCHENGEN] ДД/ММ/ГГГГ` (дата начала поездки, слово SCHENGEN — заглавными буквами).
3. **Тело письма** (строго по [формату консульства](https://www.exteriores.gob.es/Embajadas/belgrado/es/ServiciosConsulares/Paginas/index.aspx?scco=Serbia&scd=25&scca=Visados&scs=Lugar+de+presentaci%c3%b3n+de+solicitudes+de+visado), ничего лишнего не добавляйте — копии документов, доп. текст и вложения не нужны):
   ...
   * Fecha de nacimiento (дата рождения) — **только для детей**, для взрослых не указывается
...
4. Ждите ответ. Повторно пишите, только если нет ответа **10 рабочих дней** — это [официальная рекомендация консульства](https://www.exteriores.gob.es/Embajadas/belgrado/es/ServiciosConsulares/Paginas/index.aspx?scco=Serbia&scd=25&scca=Visados&scs=Lugar+de+presentaci%c3%b3n+de+solicitudes+de+visado).

<details>
<summary><strong>Что делать, если не ответили в течение 10 рабочих дней</strong> <i>[подробнее]</i></summary>

На сайте консульства прямо сказано:

> Из-за большого количества полученных писем обработка вашего письма может занять несколько дней. Это нормально. **Повторяйте своё сообщение, только если прошло 10 рабочих дней без ответа.**
>
> — [сайт консульства](https://www.exteriores.gob.es/Embajadas/belgrado/es/ServiciosConsulares/Paginas/index.aspx?scco=Serbia&scd=25&scca=Visados&scs=Lugar+de+presentaci%c3%b3n+de+solicitudes+de+visado)
...
**Реалии (по отзывам подававшихся в 2026 году):**

Слот — самый непредсказуемый этап, похожий на лотерею. Хотя Шенгенский кодекс разрешает подавать за 6 месяцев, на практике:

* **За 5–6 месяцев** — консульство игнорирует запросы.
* **За 4 месяца** — часто отвечают, что запись ещё не открыта, и просят написать позже.
* **За 2.5–3 месяца** — наибольшие шансы получить слот. Примеры успешных случаев:
  * Запрос в конце декабря на поездку в марте → слот на начало февраля (~за 1 мес. до поездки)
  * Запрос с начала января на поездку в апреле → слот на март (~за 1 мес. до поездки)
  * Запрос в начале февраля на поездку в конце апреля → слот на конец марта (~за 1 мес. до поездки)
* **Менее чем за 2.5 месяца** — почти всегда отвечают, что мест нет.

Итого: **2.5–3 месяца** — баланс между «слишком рано» и «мест уже нет». Но даже при правильных сроках многие заявки получают ответ «fully booked» — пробуйте снова.

<details>
<summary><strong>Нет слотов? Можно легально попасть в Испанию через другое консульство</strong> <i>[подробнее]</i></summary>
...
* Это **полностью законно**: вы подались **по правилам** (основная страна/первый въезд), под этот маршрут вам **одобрили** визу — значит даже при жёсткой проверке претензий не будет: показываете визу и свой маршрут/брони — и вопросов нет.
...
* **Анкеты** (можно от руки или на компьютере). **Не скрепляйте степлером**; сложите в порядке чек-листа:
  По одной анкете каждого вида на каждого заявителя:
  - **Визовая анкета Шенген** — [скачать PDF](https://www.exteriores.gob.es/DocumentosAuxiliaresSC/Serbia/BELGRADO%20(E)/SchengenFormESEN.pdf)
  - **Консульская анкета (чек-лист)** — [скачать PDF](https://www.exteriores.gob.es/DocumentosAuxiliaresSC/Serbia/BELGRADO%20(E)/ListaSchengen.pdf)
...
* **Медстраховка Шенген**: покрытие ≥30 000 €, вся зона Шенген, на весь срок поездки (страховки от российских компаний не принимают). 
* **Авиабилеты:** консульство хочет видеть именно **купленные билеты**, а не резервы или фиктивные брони. Рекомендуется покупать **возвратные билеты** (например, Air Serbia легко оформляет возврат).
* **Бронь проживания:** полной оплаты отеля до заезда не требуют, достаточно подтверждения бронирования.
* **Краткий план поездки** (на английском или испанском) — маршрут и цели.

<details>
<summary><strong>Про 5-летние и 10-летние паспорта</strong> <i>[подробнее]</i></summary>

Небиометрические 5-летние паспорта принимают у детей до 12 лет, у взрослых могут быть проблемы. Для 5-летних дают шенгенскую визу с ограничениями (в скобках указывают страны, куда нельзя). Многие страны Шенгена (например, Франция) не пропускают даже транзитом с 5-летним, что ограничивает маршруты и может стать причиной отказа. Для справки: с лета 2025 испанское консульство в Петербурге небиометрические паспорта уже не принимает — не исключено, что Белград последует тому же курсу.

</details>

<details>
<summary><strong>2.2. Язык документов и переводы</strong> — официально ES/SR; RU-свидетельства лучше перевести на ES <i>[подробнее]</i></summary>
...
<details>
<summary>Как считается сумма и откуда берутся цифры <i>[подробнее]</i></summary>
...
<details>
<summary><strong>Важно: это минимум, а не гарантия — покажите больше и движение по счёту</strong> <i>[подробнее]</i></summary>

Это минимум **только на саму поездку**. На практике нужно показать **дополнительные накопления** сверх этой суммы — чем больше, тем лучше. Есть случаи отказов из-за недостаточности средств при показе только минимума. Важно показать не просто остаток, но и **движение по счёту**, показывающее, что деньги не заёмные и вы реально ими распоряжаетесь в течение продолжительного периода.

</details>

<details>
<summary><strong>A) Наёмный сотрудник</strong> — справка с работы, выписка по счёту <i>[подробнее]</i></summary>
...
<details>
<summary><strong>B) Индивидуальный предприниматель (предузетник)</strong> — АПР, инвойсы, выписки <i>[подробнее]</i></summary>
...
<details>
<summary><strong>C) Спонсорство (супруг/родитель)</strong> — письмо, подтверждение родства, финансы спонсора <i>[подробнее]</i></summary>
...
**Возьмите:** полный пакет (оригиналы+копии), анкету с фото, **консульский сбор наличными** (сумма зависит от возраста, см. «Контакты и базовая информация»), паспорт и ВНЖ.
...
> [!WARNING]
> **С августа 2025 и по сей день** визы выдают **за 1–2 дня до вылета**, даже если паспорт был подан 2–3 месяца назад. Очень редко выдают за неделю до полёта. Будьте готовы к ожиданию до последнего момента. 
...
* **Когда:** после статуса `Resuelto` или получения email с темой "Solicitud de visado" (в письме будет "APROBADA" — одобрено, или другое решение при отказе). **Важно:** регулярно проверяйте статус на сайте — там может появиться статус дозапроса документов, о котором консульство не всегда сообщает по email. Если видите дозапрос — напишите на [emb.belgrado.info@maec.es](mailto:emb.belgrado.info@maec.es), чтобы уточнить, что именно нужно. Если не отвечают — идите в консульство лично.
* **Где/когда:** консульство, 13:00–13:30, любой рабочий день, без записи. Возьмите расписку с номером дела.
* **Важно:** Визу нужно забрать в течение **1 месяца** с момента получения уведомления, иначе считается отказом от визы.

<details>
<summary><strong>Что обычно выдают (практика Белграда)</strong> <i>[подробнее]</i></summary>
...
1. **Испанская история идёт «с нуля».** Визы, выданные другими консульствами Шенгена (включая испанские консульства в других странах), **не учитываются** при принятии решения.
2. **Смена консула (лето 2025):** ужесточение слотов, требовательность к языку документов. По слухам, квота на туристические слоты была урезана примерно на 90%.
3. **Финансы ИП** проверяют особенно строго: печати, движение, контракты/инвойсы.
4. Типовые причины отказов/задержек: слабые финансы, нелогичный маршрут, короткий остаток ВНЖ, неполный пакет, выписки без печати.
5. **Миф про охранника:** в сети ходят слухи, что через охранника на входе в консульство можно «купить» или получить слот. Это неправда — охранник не имеет никакого отношения к распределению мест.
