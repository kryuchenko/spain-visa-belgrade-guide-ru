...
* **Загранпаспорт 10-летний (биометрический)** + копия первой страницы. **Важно:** На октябрь 2025 небиометрические 5-летние паспорта принимают у детей до 12 лет. Для 5 летних дают шенгенскую визу с ограничениями (в скобках указывают страны, куда нельзя), но **настоятельно рекомендуется 10-летний** — многие страны Шенгена (например, Франция) не пропускают даже транзитом с 5-летним, что ограничивает маршруты и может стать причиной отказа. Справочно: в Питере с лета 2025 испанское консульство небиометрические паспорта не принимает.
