...
> [!TIP]
> **Нет слотов в Испании? Подайтесь через другую страну Шенгена.**
>
> По шенгенским правилам визу нужно запрашивать в консульстве той страны, где вы проведёте **наибольшее число дней**. Если дней поровну — в консульстве страны **первого въезда** в Шенген.
>
> Это значит, что можно спланировать поездку так, чтобы подаваться в другое консульство, где слоты есть:
> * **Дней поровну** → подаётесь в страну первого въезда. Пример: 5 дней Франция + 5 дней Испания, въезд через Францию → подаётесь во Францию.
> * **Дней больше в другой стране** → подаётесь туда. Пример: 5 дней Испания + 6 дней Франция → подаётесь во Францию, а в Испанию въезжаете по этой же визе.
>
> Франция — не единственный вариант, подойдёт **любая страна Шенгена**, консульство которой в Белграде выдаёт слоты.
