...
**ВАЖНО:** Это минимум **только на саму поездку**. На практике нужно показать **дополнительные накопления** сверх этой суммы — чем больше, тем лучше. Есть случаи отказов из-за недостаточности средств при показе только минимума.
